                                        ...
                                        <form class="form"
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label for="projectinput1"> اختر العلامات الدلاليه
                                                            </label>

                                                            <select class="select2 form-control" id="inputGroupSelect01" name ="tag[]" multiple>
                                                                <optgroup label="من فضلخ اختر علامه">
