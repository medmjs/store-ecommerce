        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="nav-item closed ">
                <a href=""><i class="la la-home"></i>
                    ...
                    <span
                        class="badge badge badge-info badge-pill float-right mr-2">Lang</span>
                </a>
            ...
            <li class="nav-item "><a href="{{route('admin.subCatigories')}}"><i class="la la-group"></i>
                ...
                <ul class="menu-content">
                    <li class="active"><a class="menu-item" href="{{route('admin.subCatigories')}}"
                                          data-i18n="nav.dash.ecommerce"> عرض الكل </a>
                    </li>
                    <li><a class="menu-item" href="{{route('admin.subCatigories.create')}}" data-i18n="nav.dash.crypto">أضافة
                            قسم فرعي جديد </a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item"><a href=""><i class="la la-male"></i>
                ...
                <ul class="menu-content">
                     ...
                     <li><a class="menu-item" href="{{route('admin.Option')}}" data-i18n="nav.dash.crypto">عرض قيم الخصاص
                              </a>
                    </li>
                     <li><a class="menu-item" href="{{route('admin.Option.create')}}" data-i18n="nav.dash.crypto">اضافةقيم 
                              </a>
                    </li>
                </ul>
            </li>
