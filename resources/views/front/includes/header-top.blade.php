                                ...
                                <div class="language-item">
                                    <div>
                                        <a href="http://demo.bestprestashoptheme.com/savemart/fr/?home=home_3">
                                            <img class="img-fluid" src="{{asset('assets/front/img/2.jpg')}}" alt="Français" width="16" height="11">
                                            <span>Français</span>
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="language-item">
                                    <div>
                                        <a href="http://demo.bestprestashoptheme.com/savemart/it/?home=home_3">
                                            <img class="img-fluid" src="{{asset('assets/front/img/1.jpg')}}" alt="Italiano" width="16" height="11">
                                            <span>Italiano</span>
                                        </a>
                                    </div>
                                </div>
